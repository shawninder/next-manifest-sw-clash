# Next.js Manifest-ServiceWorker Clash

Trying to reproduce an integration problem that prevents one from using both `next-manifest` and `next-offline` in the same Next.js project.

- [next-manifest issue](https://github.com/ragingwind/next-manifest/issues/5)
- [next-offline issue](https://github.com/hanford/next-offline/issues/67)
